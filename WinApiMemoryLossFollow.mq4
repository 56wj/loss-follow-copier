                                 ...
                                 const double volume)
{
   ...
   double price_delta = position_type == M4_POSITION_TYPE_BUY
                        ? bid - open_price
                        : open_price - ask;
...
bool IsCopyDirectionAllowed(const ENUM_M4_POSITION_TYPE position_type)
{
   if(InpCopyDirection == COPY_DIRECTION_BUY_ONLY)
      return position_type == M4_POSITION_TYPE_BUY;

   if(InpCopyDirection == COPY_DIRECTION_SELL_ONLY)
      return position_type == M4_POSITION_TYPE_SELL;

   return position_type == M4_POSITION_TYPE_BUY || position_type == M4_POSITION_TYPE_SELL;
}
                    ...
                    ENUM_M4_POSITION_TYPE& position_type)
{
   ...
   symbol = parts[1];
   position_type = (ENUM_M4_POSITION_TYPE)StringToInteger(parts[2]);
                           ...
                           bool& total_loss_group)
{
   ...
   position_type = total_loss_group
                   ? M4_POSITION_TYPE_BUY
                   : (ENUM_M4_POSITION_TYPE)StringToInteger(parts[2]);
   return profile_index > 0 && symbol != "";
}
